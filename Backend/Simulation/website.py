...
class Website:
    def __init__(self, users: dict, no_of_links: int, unfriend_chance: numeric, initial_connections: int, communication_mode: str, users_communication_mode: str, user_positions: dict):
    ...
    def step(self):
        ...
        for i in  users_order:
            users_to_moved = users_to_moved.union(self.users_communication(self.users, i))
